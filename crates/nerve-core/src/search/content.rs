...
pub(super) fn collect_content_matches<P: CatalogProvider + Sync>(
    ...
    cancel: &CancelToken,
) -> Result<ContentSearchSummary, NerveError> {
...
pub(super) fn plan_content_entries<'a>(
    ...
    filter: &EntryFilter,
    cancel: &CancelToken,
) -> Result<(Vec<&'a CatalogEntry>, bool), NerveError> {
...
pub(super) fn content_search_results<P: CatalogProvider + Sync>(
    ...
    cancel: &CancelToken,
) -> Vec<Result<ContentSearchResult, NerveError>> {
...
pub(super) fn content_search_file<P: CatalogProvider + Sync>(
    ...
    binary_skipped: &AtomicUsize,
    cancel: &CancelToken,
) -> Result<ContentSearchResult, NerveError> {
    cancel.check_cancelled()?;
...
pub(super) fn content_matches_for_file(
    ...
    cancel: &CancelToken,
) -> Result<ContentMatchSet, NerveError> {
