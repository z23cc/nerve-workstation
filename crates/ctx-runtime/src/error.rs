use ctx_core::dispatch::dispatch_error_kind;
use ctx_core::{CtxError, DispatchError};
use thiserror::Error;
...
impl RuntimeError {
    ...
    pub fn cancelled() -> Self {
        Self::Core(DispatchError::Core(CtxError::Cancelled))
    }
    ...
    pub fn is_cancelled(&self) -> bool {
        matches!(self, Self::Core(DispatchError::Core(CtxError::Cancelled)))
    }
}
